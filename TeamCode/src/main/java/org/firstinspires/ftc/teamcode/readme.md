...
1)  Using your operating system file management tools, copy the whole "TeamCode"
    folder to a sibling folder with a corresponding new name, eg: "Team21734".

2)  In the new Team21734 folder, delete the TeamCode.iml file.
...
5)  Add:    include ':Team21734' to the "/settings.gradle" file.
