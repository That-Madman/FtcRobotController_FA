...
class BlueAudienceAuto : OpMode() {
    ...
    override fun init() {
        ...
        spike1 = drive!!.trajectorySequenceBuilder(drive!!.poseEstimate)
            ...
            .splineToConstantHeading(Vector2d(-32.0, 32.0), toRadians(315.0))
        ...
        board2 = drive!!.trajectorySequenceBuilder(spike2!!.end())
            ...
            .lineToConstantHeading(Vector2d(-49.0, 5.0))
            .lineToLinearHeading(Pose2d(-20.0, 5.0, toRadians(0.0)))
            .lineToConstantHeading(Vector2d(35.0, 5.0))
            .lineToLinearHeading(Pose2d(44.0, 32.0, 0.0))
            .lineToConstantHeading(Vector2d(52.0, 31.5))
            .build()
